...
RSpec.describe 'merchant discounts index page' do
  ...
  it 'lists all discounts and their percentage discount and quantity threshold' do
    expect(page).to have_content("10 at 10")
    ...
    expect(page).to_not have_content("20 at 20")
